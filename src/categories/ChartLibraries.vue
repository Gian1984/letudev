        ...
        <div>
            ...
            <nav class="hidden sm:flex" aria-label="Breadcrumb">
              <ol role="list" class="flex items-center space-x-4">
                ...
                <li>
                  <div class="flex items-center">
                    <ChevronRightIcon class="flex-shrink-0 h-5 w-5 text-gray-400" aria-hidden="true" />
                    <router-link to="/chartlibraries" aria-current="page" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">Javascript Chart Libraries</router-link>
                  </div>
                </li>
              </ol>
            </nav>
          ...
          <div class="mt-2 md:flex md:items-center md:justify-between">
            <div class="flex-1 min-w-0">
              <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate">Javascript Chart Libraries</h2>
...
const projects = [
  { name: 'ChartJS', href:"https://www.chartjs.org/", desc:'Simple yet flexible JavaScript charting for designers &amp; developers', bgColor: 'bg-pink-600' },
  { name: 'FrappeJS', href:"https://frappe.io/charts", desc:'Includes Green squares grid like in GitHub, and other charts to use.', bgColor: 'bg-purple-600' },
  { name: 'G2Plot', href:"https://g2plot.antv.vision/en", desc:'G2Plot is an interactive and responsive charting library based on the grammar of graphics.', bgColor: 'bg-yellow-500' },
  { name: 'Google Charts', href:"https://developers.google.com/chart/", desc: 'Get the experience from Google to create similar charts that Google uses.', bgColor: 'bg-green-500' },
  { name: 'Data Driven Documents (D3)', href:"https://d3js.org/", desc:'Bind complicated and massive data to interactive graphs.', bgColor: 'bg-orange-500' },
  { name: 'ApexCharts.Js', href:"https://apexcharts.com/", desc: 'Modern & Interactive Open-source Charts', bgColor: 'bg-blue-500' },
  { name: 'Chartist', href:"http://gionkunz.github.io/chartist-js/index.html", desc:'Simple responsive charts', bgColor: 'bg-cyan-500' },
  { name: 'Vizzu', href:"https://lib.vizzuhq.com/0.3.0/", desc:'Vizzu - a free, open-source Javascript library for building animated charts, data stories, and interactive explorers.', bgColor: 'bg-sky-500' },
]
