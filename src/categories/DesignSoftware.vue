        ...
        <div>
            ...
            <nav class="hidden sm:flex" aria-label="Breadcrumb">
              <ol role="list" class="flex items-center space-x-4">
                ...
                <li>
                  <div class="flex items-center">
                    <ChevronRightIcon class="flex-shrink-0 h-5 w-5 text-gray-400" aria-hidden="true" />
                    <router-link to="/designsoftware" aria-current="page" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">Downloadable Design Software</router-link>
                  </div>
                </li>
              </ol>
            </nav>
          ...
          <div class="mt-2 md:flex md:items-center md:justify-between">
            <div class="flex-1 min-w-0">
              <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate">Downloadable Design Software</h2>
...
const projects = [
  { name: 'Gimp', href:"https://www.gimp.org/", desc:'Free &; open source image editor similar to Photoshop', bgColor: 'bg-pink-600' },
  { name: 'Gravit Designer', href:"https://www.designer.io/en/", desc:'Free full-featured vector graphic design app that works on ALL platforms', bgColor: 'bg-purple-600' },
  { name: 'Blender', href:"https://www.blender.org/download/", desc: 'Open source, free animation, 3D modeling, etc.', bgColor: 'bg-yellow-500' },
  { name: 'Raw Therapee', href:"https://rawtherapee.com/", desc: 'Cross-platform raw image processing program', bgColor: 'bg-green-500' },
  { name: 'Be Funky', href:"https://www.befunky.com/features/graphic-designer/", desc: 'Online design program', bgColor: 'bg-orange-500' },
  { name: 'Krita', href:"https://krita.org/en/download/krita-desktop/", desc: 'Sketching and painting program designed for digital artists', bgColor: 'bg-blue-500' },
  { name: 'Pencil Project', href:"https://pencil.evolus.vn/", desc: 'GUI prototyping software', bgColor: 'bg-cyan-500' },
  { name: 'Inkscape', href:"https://inkscape.org/", desc: 'Powerful free design tool', bgColor: 'bg-sky-500' },
  { name: 'Adobe XD', href:"https://www.adobe.com/products/xd.html", desc: 'Free design tool from Adobe', bgColor: 'bg-amber-500' },
  { name: 'Shapes.so', href:"https://shape.so/pricing", desc: 'Icons that can be used as code in your projects', bgColor: 'bg-red-500' },
  { name: 'Lunacy', href:"https://icons8.com/lunacy", desc: 'Sketch for Windows', bgColor: 'bg-emerald-500' },
  { name: 'InVision Studio', href:"https://www.invisionapp.com/studio", desc: 'Free screen designing tool from InVision', bgColor: 'bg-pink-500' },
  { name: 'Darktable', href:"https://www.darktable.org/", desc:'Free & Open source photography workflow application and raw developer', bgColor: 'bg-purple-600' },
  { name: 'Inpixio photo Editor', href:"https://www.inpixio.com/free-photo-editor"  , desc: 'Free Photo Editor: For windows only', bgColor: 'bg-yellow-500' },
  { name: 'Colorpicker', href:"https://colorpicker.fr", desc: 'Open Source colors software: Retrieve, manipulate and store your colors easily!', bgColor: 'bg-green-500' },
  { name: 'Google Web Designer', href:"https://webdesigner.withgoogle.com/", desc: 'Create engaging, interactive HTML5-based designs and motion graphics that can run on any device.', bgColor: 'bg-orange-500' },
]
