        ...
        <div>
            ...
            <nav class="hidden sm:flex" aria-label="Breadcrumb">
              <ol role="list" class="flex items-center space-x-4">
                ...
                <li>
                  <div class="flex items-center">
                    <ChevronRightIcon class="flex-shrink-0 h-5 w-5 text-gray-400" aria-hidden="true" />
                    <router-link to="/svelteuilibraries" aria-current="page" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">Svelte UI Libraries</router-link>
                  </div>
                </li>
              </ol>
            </nav>
          ...
          <div class="mt-2 md:flex md:items-center md:justify-between">
            <div class="flex-1 min-w-0">
              <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate">Svelte UI Libraries</h2>
...
const projects = [
  { name: 'Svelte Material UI', href:"https://sveltematerialui.com/", desc:'UI library for Svelte based on Material Design', bgColor: 'bg-pink-600' },
  { name: 'SvelteStrap', href:"https://bestguy.github.io/sveltestrap/", desc:'UI library for Svelte based on the Bootstrap framework', bgColor: 'bg-purple-600' },
  { name: 'Svelte Flat UI', href:"https://svelteui.js.org/", desc: 'UI library for Svelte based on Flat Design', bgColor: 'bg-yellow-500' },
  { name: 'Svelte Particles', href:"https://github.com/matteobruni/tsparticles/tree/main/components/svelte", desc: 'A lightweight Svelte component for creating particles', bgColor: 'bg-green-500' },
  { name: 'Attractions', href:"https://illright.github.io/attractions/", desc: 'A pretty cool UI kit for Svelte', bgColor: 'bg-orange-500' },
  { name: 'Svelteit', href:"https://docs.svelteit.dev", desc: 'A minimalistic UI/UX component library for Svelte and Sapper projects', bgColor: 'bg-blue-500' },
]
