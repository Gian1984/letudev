        ...
        <div>
            ...
            <nav class="hidden sm:flex" aria-label="Breadcrumb">
              <ol role="list" class="flex items-center space-x-4">
                ...
                <li>
                  <div class="flex items-center">
                    <ChevronRightIcon class="flex-shrink-0 h-5 w-5 text-gray-400" aria-hidden="true" />
                    <router-link to="/angularuilibraries" aria-current="page" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">Angular UI Libraries</router-link>
                  </div>
                </li>
              </ol>
            </nav>
          ...
          <div class="mt-2 md:flex md:items-center md:justify-between">
            <div class="flex-1 min-w-0">
              <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate">Angular UI Libraries</h2>
...
const projects = [
  { name: 'Material Angular', href:"https://material.angular.io/", desc:'UI library for Angular based on Material design', bgColor: 'bg-pink-600' },
  { name: 'NG Bootstrap', href:"https://ng-bootstrap.github.io/#/home", desc:'UI library for Angular based on the Bootstrap framework', bgColor: 'bg-purple-600' },
  { name: 'PrimeNG', href:"https://www.primefaces.org/primeng/#/", desc: 'Powerful UI component library for Angular', bgColor: 'bg-yellow-500' },
  { name: 'Onsen Angular', href:"https://onsen.io/angular2/", desc: 'Hybrid mobile and PWA UI library for Angular and Onsen UI', bgColor: 'bg-green-500' },
  { name: 'NG Lightning', href:"https://ng-lightning.github.io/ng-lightning/#/", desc: 'Native Angular components &amp; directives for Lightning Design System', bgColor: 'bg-orange-500' },
  { name: 'NG Semantic', href:"https://ng-semantic.herokuapp.com/", desc: 'UI library for Angular based on Semantic UI.', bgColor: 'bg-blue-500' },
  { name: 'Nebular', href:"https://akveo.github.io/nebular/", desc: 'Customizable UI Kit, Auth &amp; Security for Angular', bgColor: 'bg-cyan-500' },
  { name: 'Alyle UI', href:"https://alyle.io/" , desc: 'Minimal components set for Angular', bgColor: 'bg-sky-500' },
  { name: 'NGX Bootstrap', href:"https://valor-software.com/ngx-bootstrap/#/" , desc: 'Another UI library for Angular based on the Bootstrap framework', bgColor: 'bg-amber-500' },
  { name: 'NG Zorro', href:"https://ng.ant.design/", desc: 'UI library for Angular based on Ant Design', bgColor: 'bg-red-500' },
  { name: 'Pagination for datatables', href:"https://www.npmjs.com/package/ngx-pagination", desc: 'npm library for pagination', bgColor: 'bg-emerald-500' },
  { name: 'Multi select dropdown', href:"https://www.npmjs.com/package/ng-multiselect-dropdown" , desc: 'For multi select drop-dowm in forms', bgColor: 'bg-pink-500' },
  { name: 'NG Particles', href:"https://particles.matteobruni.it/" , desc:'A lightweight Angular component for creating particles', bgColor: 'bg-purple-600' },
  { name: 'Covalent UI', href:"https://teradata.github.io/covalent/v3/#/"  , desc: 'Angular UI Platform focused on solving common enterprise needs', bgColor: 'bg-yellow-500' },
  { name: 'Clarity', href:"https://clarity.design/", desc: 'CSS based Angular UI framework developed by VMware group', bgColor: 'bg-green-500' },
  { name: 'Taiga UI', href:"https://taiga-ui.dev/", desc: 'Taiga UI is fully-treeshakable Angular UI Kit consisting of multiple base libraries and several add-ons.', bgColor: 'bg-orange-500' },
]
