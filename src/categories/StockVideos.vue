        ...
        <div>
            ...
            <nav class="hidden sm:flex" aria-label="Breadcrumb">
              <ol role="list" class="flex items-center space-x-4">
                ...
                <li>
                  <div class="flex items-center">
                    <ChevronRightIcon class="flex-shrink-0 h-5 w-5 text-gray-400" aria-hidden="true" />
                    <router-link to="/stockvideos" aria-current="page" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">Stock Videos</router-link>
                  </div>
                </li>
              </ol>
            </nav>
          ...
          <div class="mt-2 md:flex md:items-center md:justify-between">
            <div class="flex-1 min-w-0">
              <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate">Stock Videos</h2>
...
const projects = [
  { name: 'Pexels', href: "https://www.pexels.com/videos", desc:'Largest library of free to use videos, donated by the community', bgColor: 'bg-pink-600' },
  { name: 'Unsplash', href:"https://www.pixabay.com/videos", desc:'Large library of free to use videos, donated by the community similar to Pexels', bgColor: 'bg-purple-600' },
  { name: 'Coverr.co', href: "https://coverr.co/", desc: 'Beautiful free stock video footage', bgColor: 'bg-yellow-500' },
  { name: 'Videezy', href: "https://www.videezy.com/", desc: 'Free HD stock footage &amp; 4K videos', bgColor: 'bg-green-500' },
  { name: 'Mix Kit', href: "https://mixkit.co/", desc: 'Stock video clips & music', bgColor: 'bg-orange-500' },
  { name: 'Life Of Vids', href: "https://www.lifeofvids.com/", desc: 'Free video clips and loops', bgColor: 'bg-blue-500' },
  { name: 'Videvo', href: "https://www.videvo.net/stock-video-footage/", desc: 'Free and premium stock videos', bgColor: 'bg-cyan-500' },
  { name: 'Loopvidz', href: "http://stock.loopvidz.com/", desc: 'Free To Use Cinema graphs Created With VIMAGE App', bgColor: 'bg-sky-500' },
  { name: 'SplitShire', href: "https://www.splitshire.com/", desc: 'Beautiful & exclusive free stock videos &amp; photos', bgColor: 'bg-amber-500' },
]
