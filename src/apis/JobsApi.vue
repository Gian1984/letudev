        ...
        <div>
            ...
            <nav class="hidden sm:flex" aria-label="Breadcrumb">
              <ol role="list" class="flex items-center space-x-4">
                ...
                <li>
                  <div class="flex items-center">
                    <ChevronRightIcon class="flex-shrink-0 h-5 w-5 text-gray-400" aria-hidden="true" />
                    <router-link to="/jobsapi" aria-current="page" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">Jobs</router-link>
                  </div>
                </li>
              </ol>
            </nav>
          ...
          <div class="mt-2 md:flex md:items-center md:justify-between">
            <div class="flex-1 min-w-0">
              <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate">Public APIs <span class="text-gray-500">/ Jobs</span></h2>
...
const apis = [
  ...
  {
    "api": "Arbeitnow",
    "desc": "API for Job board aggregator in Europe / Remote",
    "auth": "No",
    "https": "Yes",
    "cors": "Yes",
  ...
  {
    "api": "Arbeitsamt",
    "desc": "API for the \"Arbeitsamt\", which is a german Job board aggregator",
    "auth": "OAuth",
    "https": "Yes",
    "cors": "Unknown",
  ...
  {
    "api": "Open Skills",
    "desc": "Job titles, skills and related jobs data",
    "auth": "No",
    "https": "No",
    "cors": "Unknown",
  ...
  {
    "api": "The Muse",
    "desc": "Job board and company profiles",
    "auth": "apiKey",
    "https": "Yes",
    "cors": "Unknown",
  ...
  {
    "api": "Upwork",
    "desc": "Freelance job board and management system",
    "auth": "OAuth",
    "https": "Yes",
    "cors": "Unknown",
  ...
  {
    "api": "ZipRecruiter",
    "desc": "Job search app and website",
    "auth": "apiKey",
    "https": "Yes",
    "cors": "Unknown",
